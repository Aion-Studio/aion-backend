...
// use crate::prisma::action_completed::{self, updated_at, hero_id, created_at};
// use crate::prisma::hero_region::current_location;
// use crate::prisma::{
//     attributes, base_stats, follower, hero, hero_resource, inventory, item, region, retinue_slot,
//     ResourceType,
// };
...
//             .order_by(created_at::order(Direction::Desc))
//             .take(1)
//             .exec()
//             .await
//             .unwrap();
...
//             Some(resources) => {
//                 HashMap::from_iter(resources.into_iter().map(|r| (r.into(), r.amount)))
//             }
//             None => HashMap::new(),
//         };
//
